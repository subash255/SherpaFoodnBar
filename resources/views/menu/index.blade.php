    ...
    <body class="bg-gray-100">
        ...
        <div class="container mx-auto p-4 flex flex-col lg:flex-row space-y-4 lg:space-y-0 lg:space-x-4">
            ...
            <aside class="w-full lg:w-1/4 bg-white shadow-lg rounded-lg p-4">
                ...
                <div class="mb-4 flex">
                    <!-- Search Input -->
                    <input type="text" id="search" placeholder="Search by dish name"
        ...
        <script>
            ...
            function filterFoodItemsAndCategories(query) {
                ...
                categories.forEach(category => {
                    const foodItems = category.querySelectorAll(
                    '.food-item'); // Select all food items in the current category
                    ...
                    foodItems.forEach(foodItem => {
                        ...
                        const foodDescription = foodItem.querySelector('p.text-sm').textContent
                    .toLowerCase(); // Food description
            ...
            window.addEventListener('popstate', function() {
                ...
                filterFoodItemsAndCategories(
                searchQuery); // Filter the food items and categories based on the search query
            });
            ...
            function filterFoodItems() {
                ...
                const selectedTypes = Array.from(document.querySelectorAll('.filter-checkbox:checked')).map(checkbox => checkbox
                    .value);
